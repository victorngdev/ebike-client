                ...
                <aside className="col-md-5 catalog-title">
                    ...
                    <div className="description w-90">
                        <p>
                            ...
                            attainable, and has put 50,000 new riders on the
                            road. Tens of thousands have purchased SONDORS
                            without ever riding one, and now they're obsessed.
                            In 2020, we're on a mission to reach a fleet of
